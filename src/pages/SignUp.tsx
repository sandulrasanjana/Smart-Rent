        ...
        <div className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
            <div className="max-w-md w-full space-y-8">
                ...
                <div className="text-center space-y-2">
                    ...
                    <p className="text-neutral-400">Join SmartRent and start renting today</p>
                </div>
                ...
                <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-8 space-y-6">
                    ...
                    <label className="flex items-start gap-2 text-sm text-neutral-400 cursor-pointer">
                        <input
                            type="checkbox"
                            className="w-4 h-4 rounded border-neutral-700 bg-neutral-950 text-emerald-500 focus:ring-emerald-500/50 mt-0.5"
                        />
                        <span>
                            I agree to the{' '}
